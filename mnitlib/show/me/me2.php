...
<!-- ################################php section####################################################################### -->
<?php
$b_query = "SELECT * FROM books WHERE dept = 'ME' AND status = 'PROPOSED'";
$b_result = mysqli_query($db,$b_query) or die("ERROR QUERYING DATABAse".mysqli_error($db));
?>
<!-- ####################################################################################################### -->

      <ul>
        <h1 class="title">MECHANICAL ENGINEERING PROPOSED PROPOSALS</h1>
...
<table border=1 cellpadding=0 cellspacing=0>
 ...
 <td><input size="10"type="text" id="req_by" name="req_by" value="<?php echo($b_row['req_by']);?>" readonly></td> 
 ...
 <td><input size="7"type="text" id="target" value=<?php echo($b_row['target']);?> readonly></td>
 </table><br>
<table border=1 cellpadding= cellspacing=0>
 ...
 <th>SC:<input type="text" id="sc" name="sc" value=<?php echo($b_row['bank_sc']);?> size="2"
  ...
  <th>ST:<input type="text" id="st" name="st" value=<?php echo($b_row['bank_st']);?> size="2"
          onchange="updateOrder();" /></th>
  <th>GEN:<input type="text" id="gen" name="gen" value=<?php echo($b_row['bank_gen']);?> size="2" 
          onchange="updateOrder();" /></th>
<th>Other&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>


<th>Library:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" id="library" name="library" value=<?php echo($b_row['library']);?> size="2"  onchange="updateOrder();" /></th>

<td>Reference:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" id="reference" name="reference" value=<?php echo($b_row['reference']);?> size="2"  onchange="updateOrder();" /></td>
