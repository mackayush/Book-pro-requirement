...
<!-- ####################################################################################################### -->
      ...
      <ul>
        <h1 class="title">YOUR PREVIOUS BOOK PROPOSALS</h1>
...
<table border=1 cellpadding=0 cellspacing=0>
 ...
 <input type="hidden" id="id" name="id" value=<?php echo($b_row['book_id']);?> readonly>
...
<td>Priority:<input  id="priority" name="priority" value=<?php echo($b_row['priority']);?> readonly></td>
 ...
 <input type="submit" value="Edit and Save"/></form>
 </html>
<?php
}
?>
